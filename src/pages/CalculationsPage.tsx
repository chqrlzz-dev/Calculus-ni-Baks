            ...
            <Card className="border-none bg-muted/20 rounded-[32px] overflow-hidden">
              <CardContent className="p-8 space-y-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-black text-[10px] uppercase tracking-widest text-muted-foreground">Standard 50-Point Base</h3>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Used by most Engineering instructors (e.g., Diff/Integral Cal). It translates a raw score of 0% to 50% and 100% to 100%. This provides a safety net for students in technical subjects.
                </p>
                <div className="bg-background/50 p-6 rounded-2xl border border-white/5">
                  <BlockMath>{`\\text{Result} = \\left( \\frac{\\text{Raw}}{\\text{Max}} \\times 50 \\right) + 50`}</BlockMath>
                </div>
              </CardContent>
            </Card>
